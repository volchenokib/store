...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/MyAccount/BillingAddressForm.vue?vue&type=template&id=24197c9c&
...
var errors = ref.errors;
return [_c('SfInput',{staticClass:"form__element",attrs:{"data-cy":"billing-details-input_city","name":"city","label":"City","valid":!errors[0],"errorMessage":errors[0]},model:{value:(_vm.form.city),callback:function ($$v) {_vm.$set(_vm.form, "city", $$v)},expression:"form.city"}})]}}],null,true)}),_vm._v(" "),_c('ValidationProvider',{staticClass:"col-6",attrs:{"rules":("required|oneOf:" + (_vm.provience.map(function (c) { return c.name; }).join(',')))},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
return [_c('SfSelect',{staticClass:"form__select sf-select--underlined form__element",attrs:{"data-cy":"billing-details-input_state","name":"state","label":"State/Province","valid":!errors[0],"errorMessage":errors[0]},model:{value:(_vm.form.state),callback:function ($$v) {_vm.$set(_vm.form, "state", $$v)},expression:"form.state"}},_vm._l((_vm.provience),function(ref){
var name = ref.name;
var label = ref.label;
return _c('SfSelectOption',{key:name,attrs:{"value":name}},[_vm._v("\n              "+_vm._s(label)+"\n            ")])}),1)]}}],null,true)})],1),_vm._v(" "),_c('div',{staticClass:"row"},[_c('ValidationProvider',{staticClass:"col-6",attrs:{"rules":"required|min:4","tag":"div"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var errors = ref.errors;
...
// CONCATENATED MODULE: ./components/MyAccount/BillingAddressForm.vue?vue&type=template&id=24197c9c&
...
var UserBillingAddress = __webpack_require__(271);

// EXTERNAL MODULE: ./components/MyAccount/BillingAddressForm.vue + 4 modules
var BillingAddressForm = __webpack_require__(272);
